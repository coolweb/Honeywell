...
?>
   ...
   <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
    <legend>{{Mes appareils honeywell}}
    </legend>
    ...
    <form class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label">{{Nom de l'équipement honeywell}}</label>
                <div class="col-sm-3">
...
<?php include_file('desktop', 'honeywell', 'js', 'honeywell');?>